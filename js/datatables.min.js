 ...
 *   https://datatables.net/download/#bs4/jq-3.3.1/dt-1.10.18/af-2.3.3/b-1.5.6/sc-2.0.0
 *
 * Included libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.18, AutoFill 2.3.3, Buttons 1.5.6, Scroller 2.0.0
 */
...
(function(h) {
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      // sInfo: "該当件数 _START_ 〜 _END_ / 合計 _TOTAL_ 件",
      // sInfo: "表示 _START_ 〜 _END_ 件",
      sInfo: "",
      sInfoEmpty: " ",
      // sInfoEmpty: "該当件数 0 〜 0 of 0 合計",
      // sInfoFiltered: "(filtered from _MAX_ 合計　total 件)",
      sInfoFiltered: "_MAX_ 件",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "表示項目数 _MENU_",
  ...
  n.models.oSettings = {
    ...
    fnRecordsDisplay: function() {
      return "ssp" == y(this) ? 1 * this._iRecordsDisplay : this.aiDisplay.length -1
    },
  ...
  n.ext = x = {
    buttons: {},
    classes: {},
    build: "bs4/jq-3.3.1/dt-1.10.18/af-2.3.3/b-1.5.6/sc-2.0.0",
    errMode: "alert",
    feature: [],
    search: [],
    selector: {
...
(function(d) {
  ...
  var p = d.fn.dataTable,
    g = function(a, b) {
      this instanceof g ? (b === n && (b = {}), a = d.fn.dataTable.Api(a), this.s = {
        ...
        mousedown: !1,
        lastScrollTop: 0
      }, this.s = d.extend(this.s, g.oDefaults, b), this.s.heights.row = this.s.rowHeight, this.dom = {
  ...
  d.extend(g.prototype, {
    measure: function(a) {
      ...
      b.row && (b.viewport = d.contains(k, this.dom.scroller) ? this.dom.scroller.clientHeight : this._parseHeight(d(this.dom.scroller).css("height")), b.viewport || (b.viewport = this._parseHeight(d(this.dom.scroller).css("max-height"))), this.s.viewportRows = parseInt(b.viewport / b.row, 10) + 1, this.s.dt._iDisplayLength =
    ...
    scrollToRow: function(a, b) {
      ...
      0 > m && (m = 0);
      (f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== m && (e = !0, f = this._domain("virtualToPhysical",
        a * this.s.heights.row), this.s.redrawTop < f && f < this.s.redrawBottom && (this.s.forceReposition = !0, b = !1));
      "undefined" == typeof b || b ? (this.s.ani = e, d(this.dom.scroller).animate({
        scrollTop: f
      }, function() {
        setTimeout(function() {
          c.s.ani = !1
    ...
    construct: function() {
      ...
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        this.dom.scroller =
          d("div." + this.s.dt.oClasses.sScrollBody, this.s.dt.nTableWrapper)[0];
        ...
        this.s.loadingIndicator && (this.dom.loader = d('<div class="dataTables_processing dts_loading">' + this.s.dt.oLanguage.sLoadingRecords + "</div>").css("display",
          "none"), d(this.dom.scroller.parentNode).css("position", "relative").append(this.dom.loader));
        ...
        d(this.dom.scroller).on("mousedown.dt-scroller",
          function() {
            a.s.mousedown = !0
        ...
        e && e.scroller && (this.s.topRowFloat = e.scroller.topRow, this.s.baseScrollTop = e.scroller.baseScrollTop, this.s.baseRowTop =
          e.scroller.baseRowTop);
    ...
    _calcRowHeight: function() {
      var a = this.s.dt,
        ...
        f = d('<div class="' + a.oClasses.sWrapper + ' DTS"><div class="' + a.oClasses.sScrollWrapper + '"><div class="' + a.oClasses.sScrollBody + '"></div></div></div>');
      d("tbody tr:lt(4)", b).clone().appendTo(e);
      var m = d("tr", e).length;
      if (1 === m) e.prepend("<tr><td>&#160;</td></tr>"), e.append("<tr><td>&#160;</td></tr>");
      else
        for (; 3 > m; m++) e.append("<tr><td>&#160;</td></tr>");
      d("div." +
    ...
    _draw: function() {
      ...
      c = "jump" === this.scrollType ?
        this._domain("physicalToVirtual", this.s.topRowFloat * b.row) : c;
      ...
      this.s.dt.oFeatures.bStateSave && null !==
        this.s.dt.oLoadedState && "undefined" != typeof this.s.dt.oLoadedState.iScroller ? ((c = !this.s.dt.sAjaxSource && !a.s.dt.ajax || this.s.dt.oFeatures.bServerSide ? !1 : !0) && 2 == this.s.dt.iDraw || !c && 1 == this.s.dt.iDraw) && setTimeout(function() {
    ...
    _domain: function(a, b) {
      ...
      if ("virtualToPhysical" === a && b > c.virtual - 1E4) return b = c.virtual - b, c.scroll - b;
      if ("physicalToVirtual" === a && b > c.scroll - 1E4) return b = c.scroll - b, c.virtual - b;
      c = (("virtualToPhysical" === a ? c.scroll : c.virtual) - 1E4) / (("virtualToPhysical" === a ? c.virtual : c.scroll) - 1E4);
    ...
    _info: function() {
      if (this.s.dt.oFeatures.bInfo) {
        ...
        h = 0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal() ? b.sInfoEmpty + b.sInfoPostFix : 0 === a.fnRecordsDisplay() ? b.sInfoEmpty + " " + b.sInfoFiltered.replace("_MAX_", l) + b.sInfoPostFix : a.fnRecordsDisplay() ==
          a.fnRecordsTotal() ? b.sInfo.replace("_START_", h).replace("_END_", k).replace("_MAX_", l).replace("", n) + b.sInfoPostFix : b.sInfo.replace("_START_", h).replace("_END_", k).replace("_MAX_", l).replace("", n) + " " + b.sInfoFiltered.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal())) + b.sInfoPostFix;
    ...
    _parseHeight: function(a) {
      ...
      a = parseFloat(c[1]);
      c = c[2];
      "px" === c ? b = a : "vh" === c ? b = a / 100 * d(h).height() : "rem" === c ? b = a * parseFloat(d(":root").css("font-size")) : "em" === c && (b = a * parseFloat(d("body").css("font-size")));
      return b ? b : 0
    },
    _scroll: function() {
      var a = this,
      ...
      if (!this.s.skip && !this.s.ingnoreScroll && c !== this.s.lastScrollTop)
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
          ...
          if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
            ...
            f != this.s.dt._iDisplayStart && (this.s.tableTop = d(this.s.dt.nTable).offset().top, this.s.tableBottom = d(this.s.dt.nTable).height() + this.s.tableTop, e = function() {
                null === a.s.scrollDrawReq && (a.s.scrollDrawReq = c);
                a.s.dt._iDisplayStart = f;
                a.s.dt.oApi._fnDraw(a.s.dt)
              }, this.s.dt.oFeatures.bServerSide ? (clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(e, this.s.serverWait)) :
